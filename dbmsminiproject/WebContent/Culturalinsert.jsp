...
<div class=delete>
<ul>
    <li><a href="deletecultural.jsp"><button>DELETE</button><a/><li>
    <li><a href="deletecultural.jsp"><button>UPDATE</button><a/><li>
</ul>
</div>
<h1 align="center">CULTURAL TABLE</h1>

<div>
  <form class = "ff" action="Culturalinsert.jsp">
...
<label >Time</label>
   <br> <input type="time" name="e" placeholder="enter time" required>
...
String q="insert into cultural values(?,?,?,?,?)";  
 //
