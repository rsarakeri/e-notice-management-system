...
<%!String psw = "";%>
<%
String first_name=request.getParameter("event_name");
...
String sql="Update cultural set event_name=?,coordinator_id=?,venue=?,date=?,time=? where coordinator_id="+last_name;
...
if(i > 0)
{
out.println("<script>alert('updated!! Sucessfully');window.location.href='deletecultural.jsp';</script>");  
